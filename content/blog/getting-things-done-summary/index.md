...
description: "getting things done summary"
tags: ["productivity"]
---

# Goals/Context for having todo list
- trusted place I can easily find and look at to see additional/support information on any projects that is working on
- reliable place for ideas and tasks
- maintain perspective and trust in the focus and the priorities
- getting in-tray(s) to zero
- avoid open loops and cognitive loads in the mind to remember the open loops
- reference system to retrieve information within 30 seconds or less
- easy to access to the visualization of the tasks in the inbox/today/next action lists, so it’s easier for you to take action
...
- make it easy to extract the information out of the the brains
  - it usually takes less than 30 seconds to create the todoist item on the phone
...
- use Todoist Gmail plugin to create a task and put it in the in-tray
...
- If there’s an inbox item and There’s no project fit for it, then it should be deleted forever.
- create todo item from voice command
  ...
  - Siri Action
    ...
    - tell the title of the action to Siri, it prompts the title of the card.
...
- When you choose not to document something in your inbox
  ...
  - after deciding the reason(s) not to do the task
    - move the item from your inbox into a new Project. Let this project have only one task: do it! Move this new Project up your list of Projects until everything above it is clearly more urgent
    - create a new recurring task called "Decide when to do (the original task)". Give yourself a reminder once per week. If you notice that you never even decide when to do the original task, then the original task wasn't important enough or urgent enough. **Throw it away and maybe it comes back**
...
- apply Todoist label next-action on the task
- If you can’t even guess the effort of a smaller next action, then maybe the next action is “Spend 30 minutes figuring out what it means to complete this project”. Maybe the lack of vision/clarity about the “acceptance criteria” makes it hard for you to know where to start.
  - describe one next action which you can guess how long it will take—even if that next action is tiny or seems insignificant. That means moving the item from Inbox to New Project, then writing 2 tasks for that project:
...
- apply Todoist label wait-for for the specific task

# Keep a Single list of all current projects

- add project to the todoist projects list

# At least one recorded next action for each of the projects

- make sure each project has at least one task with next-action label
...
- coming up keywords with: “How am I likely to search for this 6 months from now”
...
- daily review
- use embedded widgets from Todoist on phone/browser, so the tasks in inbox/next action/today can easily be viewed and action on.
...
- tasks that hard to to classify
- maybe, “I just want to remember to have the option to do this task, but I’m OK if it waits 5 years”. Put it in Somday/Maybe or create new project for it.
- maybe, “I just need to decide once and for all to do it or not to do it”. Set a reminder for “Decide when to do X” or just put the damn thing on your calendar.
- maybe, just **delete it and it will comeback if it is significant enough**
- resolve the possible guilt about it. Put it out of your mind. You can do it either by decided “I’m going to do it on Specific date” or “I’m going to just put it in the list and I’m happy if I do it next week, next month, next year, or next decade”.
- when reviewing inbox
  - use Projects aggressively
  - if there's no projects fit for an item, delete it forever.
