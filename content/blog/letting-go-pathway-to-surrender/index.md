...
- **I can see that the mind projects causality where it isn’t, and then unconsciously tends to ignore all data to the contrary. To actually discern the cause of anything, I would have to know all that’s ever happened throughout all time, because everything is connected to everything else. Is that right?**
